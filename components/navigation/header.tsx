...
const Header = () => {
  ...
  const navigation = [
    ...
    { name: "About Us", href: "/about" },
    {
      ...
      href: "/services",
      dropdown: [
        { name: "🏗️ Building Wealth", href: "/services#building-wealth" },
        { name: "🌐 Specialized Solutions", href: "/services#specialized-solutions" },
        { name: "📋 Regulatory & Tax", href: "/services#regulatory-tax" },
        { name: "🏡 Life Transitions", href: "/services#life-transitions" },
