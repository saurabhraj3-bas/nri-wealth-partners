...
const FloatingActions = () => {
  ...
  const whatsappMessage = encodeURIComponent(
    "Hello, I would like to know more about your services for NRIs."
  )
  ...
  return (
    <div className="fixed bottom-6 right-6 z-40 flex flex-col gap-3 no-print">
      ...
      <a
        ...
        className="group flex items-center justify-center w-14 h-14 bg-[#25D366] text-white rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110"
